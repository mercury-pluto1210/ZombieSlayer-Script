...
public class EnemyController_GameOverZone : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        gameOverZone = GameObject.FindGameObjectWithTag("GameOver");
    ...
    void Move()
    {
        ...
        {
            //navMeshAgentの操作
            agent.SetDestination(gameOverZone.transform.position);
        }
